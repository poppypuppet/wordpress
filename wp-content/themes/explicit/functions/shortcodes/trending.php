...
class itTrending {	
	...
	public static function trending( $atts = null, $content = null ) {
		...
		#setup sortbar args
		$sortbarargs = array('title' => $title, 'loop' => $loop, 'location' => $location, 'view' => '', 'cols' => '', 'disabled_filters' => $disabled_filters, 'numarticles' => $postsperpage, 'disable_filters' => false, 'disable_title' => true, 'thumbnail' => true, 'rating' => false, 'meta' => false, 'layout' => '', 'cssclass' => 'light', 'timeperiod' => $timeperiod);         
		#setup timeperiod
		$week = date('W');
		$month = date('n');
		$year = date('Y');
		...
		$out .= '<div class="container">';
			...
			$out .= "<div class='row post-container trending-wrapper' data-currentquery='" . $args_encoded . "'>";
			
				$out .= $before;
			
				$out .= '<div class="col-md-12">';
				
					$out .= '<div class="trending-label bar-label">';
					...
					$out .= '<div class="trending-content clearfix">';

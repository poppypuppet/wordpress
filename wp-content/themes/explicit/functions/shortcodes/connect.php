...
class itConnect {	
	...
	public static function connect( $atts = null, $content = null ) {
		...
		$out .= '<div class="container">';
			...
			$out .= '<div class="row connect">';
			
				$out .= $before;
			
				$out .= '<div class="col-md-12">';
				
					$out .= '<div class="menu-container bar-header full-width clearfix">';
					
						if(!empty($title) || !empty($icon)) {                  
						
							$out .= '<div class="bar-label-wrapper">';
						
								$out .= '<div class="bar-label light has-icon">';
						...
						if(!it_get_setting('connect_email_disable')) {

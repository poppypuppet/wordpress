...
class it_social_tabs extends WP_Widget {
	...
	function widget( $args, $instance ) {		
		...
		if($flickr) {
			...
			echo '<ul class="flickr"></ul><br class="clearer" /><a class="styled more-link" href="http://www.flickr.com/photos/'. it_get_setting('flickr_id') . '" target="_blank">' . __( 'View more photos', IT_TEXTDOMAIN ) . ' &raquo;</a>';            
			echo '</div>';
		}
		if($comments) {

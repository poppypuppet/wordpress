...
class it_trending extends WP_Widget {
	function it_trending() {
		...
		/* Create the widget. */
		parent::__construct( 'it_trending', 'Trending', $widget_ops, $control_ops );
	}	
	function widget( $args, $instance ) {
		...
		$sortbarargs = array('title' => $title, 'loop' => 'trending', 'location' => '', 'cols' => 1, 'class' => '', 'disabled_filters' => $disabled_filters, 'numarticles' => $numarticles, 'disable_filters' => false, 'disable_title' => false, 'prefix' => false, 'view' => 'list', 'thumbnail' => false, 'rating' => false, 'meta' => true, 'award' => false, 'badge' => false, 'excerpt' => false, 'authorship' => false, 'icon' => false, 'cssclass' => 'light', 'large_first' => false, 'theme_icon' => 'trending', 'layout' => '', 'timeperiod' => $timeperiod);
		...
		echo "<div id='widgets-trending' class='post-container trending-wrapper floated no-color' data-currentquery='" . $current_query_encoded . "'>";

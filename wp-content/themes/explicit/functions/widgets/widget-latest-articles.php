...
class it_latest_articles extends WP_Widget {
			...
			if ($title) { 
				...
				echo '<div class="header clearfix">';
					...
					echo '<div class="bar-label"><span class="theme-icon-recent header-icon"></span>' . $title . '</div>';
					 ...
					 if($more) echo '<a class="styled more-link" href="' . esc_url($link) . '">' . __('View All',IT_TEXTDOMAIN) . '<span class="theme-icon-right-fat"></span></a>';
	...
	function form( $instance ) {		
		...
		$defaults = array( 'title' => 'Latest Articles', 'category' => 'All Categories', 'tag' => 'All Tags', 'numarticles' => 5, 'more' => true, 'thumbnail' => true, 'rating' => true, 'icon' => true, 'badge' => true, 'authorship' => true, 'excerpt' => true, 'award' => true, 'meta' => true, 'layout' => 'widget_a', 'first' => false);

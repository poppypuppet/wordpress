...
<?php 
$type = 'comment'; //all
$comment_num = empty($comment_num) ? '' : $comment_num;
if(have_comments()) {
...
<div id="comments">
	...
	<div class="clearfix">
        ...
        <a class="reply-link" href="#reply-form"><?php _e('Leave a reply ',IT_TEXTDOMAIN); ?><span class="theme-icon-right-fat"></span></a>
        
        <?php if(get_comment_pages_count() > 1) { ?>
        
            <div class="pagination bar-header clearfix" data-number="<?php echo $comments_per_page; ?>" data-type="<?php echo $type; ?>">
